...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="#" class="current">Add Product Attributes</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" name="add_attribute" id="add_attribute">
              ...
              <div>
                  <input type="text" name="name[]" id="name" placeholder="Name"  style="width: 200px;" required />
                  <input type="text" name="description[]" id="description" placeholder="Description"  style="width: 200px;" required />
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><input type="text" name="name[]" value="{{ $attribute->name }}">{{ $attribute->name }}</td>
                  <td><input type="text" name="description[]" value="{{ $attribute->description }}">{{ $attribute->description }}</td>
                  <td class="center">
