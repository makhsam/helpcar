...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="#" class="current">Edit Product</a> </div>
    <h1>Products</h1>
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-product/'.$productDetails->id) }}" name="edit_product" id="edit_product" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="price_two" id="price" value="{{ $productDetails->price_two }}">
                </div>
              </div>
               <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="checkbox" name="new" id="new" @if($productDetails->new=="1") checked @endif value="1">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Popular</label>
                <div class="controls">
                  <input type="checkbox" name="popular" id="popular" @if($productDetails->popular=="1") checked @endif value="1">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Best</label>
                <div class="controls">
                  <input type="checkbox" name="best" id="best" @if($productDetails->best=="1") checked @endif value="1">
                </div>
              </div>
